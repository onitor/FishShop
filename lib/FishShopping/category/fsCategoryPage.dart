  ...
  Widget _buildCategoryListItem(int index) {
    ...
    return TextButton(
      onPressed: () {
        ...
        style: ButtonStyle(
          // 这里可以设置按钮的样式，但没有直接设置 splashColor 的选项
          // 你可以设置其他属性，如 backgroundColor, foregroundColor 等
          padding: MaterialStateProperty.all(EdgeInsets.all(0)), // 设置内边距
        ),
        child: Stack(
