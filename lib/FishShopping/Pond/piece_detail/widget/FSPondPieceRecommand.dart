        ...
        child: Container(
          ...
          children: <Widget>[
            AspectRatio(
              aspectRatio: 1,
              child: Image(
                image: NetworkImage(model.userAvatar??'https://example.com/default_avatar.jpg'),
                fit: BoxFit.cover,
              ),
            ),
            ...
            Padding(
              ...
              child: Text(
                model.content??'this is a good item',
                maxLines: 1,
            ...
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  CircleAvatar(
                    backgroundImage: NetworkImage(model.userAvatar??'https://example.com/default_avatar.jpg'),
                    radius: 15,
                  ),
                  SizedBox(
                    width: 4,
