...
class _FSPondPieceWidgetState extends State<FSPondPieceWidget> {
  ...
  Widget _buildUserProfileWidget() {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          CircleAvatar(
            backgroundImage: NetworkImage(widget.model.userAvatar??'https://cataas.com/cat'),
            radius: 15,
          ),
          ...
          Text(
            widget.model.userName??'unknown user',
            style: TextStyle(
              color: Colors.black,
              fontSize: 15,
  ...
  Widget _buildContextWidget() {
    return Container(
      padding: EdgeInsets.fromLTRB(10, 0, 10, 0),
      child: Text(
        widget.model.content??'This is a beautiful pond!',
        maxLines: null,
        softWrap: true,
        style: TextStyle(
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: NetworkImage(_pic.url??'https://cataas.com/cat',),
            fit: BoxFit.cover
          )
        ),
      );
      ...
      return Container(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return _buildGridPhotoItem(widget.model.pics?[index].url??'https://cataas.com/cat');
          },
        ),
      );
    } else {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              widget.model.hotComment??'it is cool',
              maxLines: null,
              style: TextStyle(
                color: Colors.black,
                fontSize:15,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          _buildToolbarItem(Icons.chat_bubble_outline, widget.model.commentCount??'100', false),
          _buildToolbarItem(Icons.favorite, widget.model.likeCount??'122', widget.model.liked??true),
        ],
      ),
    );
  }
