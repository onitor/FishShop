...
import 'package:codes/FishShopping/Pond/comment/FSPondCommentModel.dart';
import 'package:codes/rich_text/rt_image_span.dart';
import 'package:codes/rich_text/rt_rich_text.dart';
      ...
      child: Row(
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                widget.model.liked = !(widget.model.liked??true);
              });
            },
            child: Row(
              children: <Widget>[
                Icon(
                  (widget.model.liked??true) ? Icons.favorite : Icons.favorite_border,
                  color: (widget.model.liked??true) ? Colors.yellow : Colors.black87,
                  size: 20,
                ),
                SizedBox(
                  width: 4,
