...
import 'package:codes/FishShopping/Refresh/refresh_local.dart';
import 'package:codes/FishShopping/Refresh/refresh_widget.dart';
...
abstract class RefreshChild extends StatefulWidget {
  ...
  RefreshChild({required this.controller});
...
class _DefaultRefreshState extends State<DefaultRefreshChild> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant DefaultRefreshChild oldWidget) {
