...
import 'package:codes/FishShopping/Refresh/refresh_child.dart';
import 'package:codes/FishShopping/Refresh/refresh_controller.dart';
...
class _RefreshState extends State<Refresh> with TickerProviderStateMixin {
  ...
  late RefreshWidgetController _headerValue;
  late RefreshWidgetController _footerValue;
  ...
  Widget _buildWidget() {
    ...
    Widget notificationListener = NotificationListener(
      child: widget.child == null
           ...
           : _cloneChild(widget.child) ?? Container(),
  ...
  ScrollController _tryGetControllerFrom(Widget src) {
    ...
    switch (src.runtimeType) {
      case GridView:
      case ListView:
        controller = (src as BoxScrollView).controller;
        break;
      case SingleChildScrollView:
        controller = (src as SingleChildScrollView).controller;
        break;
      default:
        controller = null;
    }
...
abstract class _RefreshHandler {
  ...
  _RefreshHandler({required this.controller, required this.callback, required this.offset});
