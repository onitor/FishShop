...
class FSMessageListItem extends StatelessWidget {
  ...
  FSMessageListItem({Key? key, required this.message, required this.isMyFollow}) : super(key: key);
    ...
    Widget avatar = Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: CachedNetworkImageProvider(message.avatar??"https://cataas.com/cat"),
          fit: BoxFit.cover,
        )
      ),
    );
      ...
      _list.add(
        Padding(
          ...
          child:  CachedNetworkImage(
            ...
            imageUrl: message.image??"https://cataas.com/cat",
